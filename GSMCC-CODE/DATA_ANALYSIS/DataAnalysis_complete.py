...
if calc_sf == 'YES':
    ...
    for i in range(0,len(projectile)):
        ...
        print_twice('  ', end = "")
        print_twice('{0:.5f} '.format(nonanti_s_r[i]), end="")
        print_twice('{0:.5f} '.format(nonanti_s_i[i]), end="")
        print_twice('    ', end = "")
        print_twice('{0:.5f} '.format(anti_s_r[i]), end="")
        print_twice('{0:.5f} '.format(anti_s_i[i]))
