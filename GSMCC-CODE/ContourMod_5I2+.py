...
#     pass
# Read file name
readfilename_array = ['IN2P3_11C_CC_GSMOpt-24.07.24-10.00_Basis-24.08.01-12.00_5I2+_SF.in']
...
for x1 in kpeak_real:
    for x2 in kmiddle_real:
        ...
        kpeak_imag = np.arange(kpeak_imag_min, 0.12+kpeak_step/2, kpeak_step)
        ...
        for readfilename in readfilename_array:
            for y1 in kpeak_imag:
                ...
                for N in N_array:
                    ...
                    #
                    sp.run(['mpirun -np 4 ./CC_exe < '+readfilename+' >> IN2P3_11C_CC_GSMOpt-24.07.24-10.00_Basis-24.08.01-12.00_5I2+_SF-24.08.04-14.00.out'], shell=True)
                    #
